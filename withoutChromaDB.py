...
# data = process_cpp_file(code, "math_utils.h")
# print(data)


# repository_path = "E:/pramu/opentext/code-describer/bitcoin"
# analysis_results = process_cpp_repository(repository_path)
...
# Example: Show all processed files
# for result in analysis_results['file_results']:
#     print(f"Processed: {result['file_path']}")

# # Example: Show global include dependencies
# print("Global include dependencies:")
# for include, dependents in analysis_results['global_dependency_graph'].get('includes', {}).items():
#     print(f"{include} is included by: {', '.join(dependents)}")
